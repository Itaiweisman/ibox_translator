...
class ScheduleList(Resource):
	...
	top = reqparse.RequestParser()
        ...
        bot.add_argument('mon', type=str, location=('schedule',), required=True)
        bot.add_argument('tue', type=str, location=('schedule',), required=True)
        bot.add_argument('wed', type=str, location=('schedule',), required=True)
        bot.add_argument('thu', type=str, location=('schedule',), required=True)
        bot.add_argument('fri', type=str, location=('schedule',), required=True)
        bot.add_argument('sat', type=str, location=('schedule',), required=True)
        bot.add_argument('sun', type=str, location=('schedule',), required=True)
        bot.add_argument('hour', type=str, location=('schedule',), required=True)
        bot.add_argument('minute', type=str, location=('schedule',), required=True)
        bot.add_argument('name', type=str, location=('schedule',), required=True)
        bot.add_argument('desc', type=str, location=('schedule',), required=True)
        bot.add_argument('period_of_keep', type=str, location=('schedule',), required=True)
        bot.add_argument('number_of_keep', type=str, location=('schedule',), required=True)
        bot.add_argument('status', type=str, location=('schedule',), required=True)
